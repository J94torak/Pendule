...
#define POSITION0 9.74//7.263//9.03//7.73
#define POSITION90 -7.04//-9.534//-8.06//-8.52
#define ORIGIN 1.2//-1.07//0.447//-0.655
#define ANGLE_15 -3.79//-4.36// -3.63//-4.49
#define ANGLE15 3.99//3.225//3.7//-1.307
